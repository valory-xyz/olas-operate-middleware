...
STAKING: t.Dict[Chain, t.Dict[str, str]] = {
    ...
    Chain.GNOSIS: {
        ...
        "quickstart_beta_mech_marketplace_expert_13": "0x1F81cF353051dAA8919d1777c58b667025794dDc",
...
DEFAULT_PRIORITY_MECH = {  # maps mech marketplace address to its default priority mech address and service id
    ...
    "0xf24eE42edA0fc9b33B7D41B06Ee8ccD2Ef7C5020": (
        "0xD091721fCB81dA1871F5903BC6AC446Dc6e0BBd6",
        609,
    ),
    ...
    "0x46C0D07F55d4F9B5Eed2Fc9680B5953e5fd7b461": (
        "0x650C77F49cFa69e2AC1990A6B4585C322B012D0d",
        194,
    ),
}
